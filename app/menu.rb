class AppDelegate
  def buildMenu
    ...
    addMenu("Bean") do
      addItemWithTitle('LED Red', action: 'led_red:', keyEquivalent: 'r')
      addItemWithTitle('LED Green', action: 'led_green:', keyEquivalent: 'g')
      addItemWithTitle('LED Clear', action: 'led_clear:', keyEquivalent: 'W')
    end
    addMenu('View') do
